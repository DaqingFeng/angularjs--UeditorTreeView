    ...
    '$timeout', function($timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          if (attrs.iconLeafdeepOne == null) {
              attrs.iconLeaf = 'fa fa-file-word-o';
          }
          if (attrs.iconLeafdeepTwo == null) {
              attrs.iconLeaf = 'fa fa-file-text-o';
          }
          ...
          on_treeData_change = function() {
            ...
            add_branch_to_list = function(level, branch, visible) {
              ...
              if (!branch.noLeaf && (!branch.children || branch.children.length === 0)) {
                ...
                if (level == 3) {
                        tree_icon = attrs.iconLeafdeepOne;
                    }
               if (level == 4) {
                        tree_icon = attrs.iconLeafdeepTwo;
                  }
              } else {
